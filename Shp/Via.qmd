...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" mimeType="" size="" description="" url="file://\\ADMIN-PC\D$\POT_2011\MAPA BASE\GEODATABASE\POT_2011.mdb" name="Personal GeoDatabase Feature Class" type="Local Area Network"/>
  </links>
  <fees></fees>
