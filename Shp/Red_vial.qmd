...
<qgis version="3.26.0-Buenos Aires">
  <identifier>Red_vial</identifier>
  <parentidentifier></parentidentifier>
  <language>SPA</language>
  <type>dataset</type>
  <title>Red_vial</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" mimeType="" size="" description="" url="file://" name="Personal GeoDatabase Feature Class" type="Local Area Network"/>
  </links>
  <fees></fees>
